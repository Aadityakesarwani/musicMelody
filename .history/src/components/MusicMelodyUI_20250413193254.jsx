...
import AccountPanel from "./AccountPanel"; // Ensure path is correct
  ...
  return (
    <div className="flex h-screen bg-gradient-to-r from-pink-50 to-purple-50">
        ...
        <div>
          <nav className="space-y-2">
            <Link to="/MusicLandingPage">
              <Button
                variant="default"
                className="w-full justify-start bg-purple-600 hover:bg-purple-700 text-white px-3 py-3 mb-4"
              >
                Home
              </Button>
            </Link>
            <Link to="/ProjectDetails">
              <Button
                variant="outline"
                className="w-full justify-start bg-purple-600 hover:bg-purple-700 text-white px-3 py-3"
              >
                Projects
              </Button>
            </Link>
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        >
          <h1
            className="text-2xl font-bold tracking-tighter sm:text-2xl md:text-2xl lg:text-4xl/none bg-clip-text text-transparent
        ...
        <section className="mt-12  space-y-4 space-x-7 mb-7">
          <h3
            className="text-xl font-bold tracking-tighter sm:text-2xl md:text-2xl lg:text-4xl/none bg-clip-text text-transparent
           bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 dark:from-purple-400
           dark:via-pink-400 dark:to-blue-400 mb-8"
          >
            Prompting Tips
          </h3>
