    ...
    <div className="flex h-screen bg-gradient-to-r from-pink-50 to-purple-50">
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        <section className="mt-12  space-y-4 space-x-7 mb-7">
          <h3 className="text-xl font-bold mb-6 font-bold tracking-tighter sm:text-2xl md:text-2xl lg:text-4xl/none bg-clip-text text-transparent
           bg-gradient-to-r from-purple-600 v ">Prompting Tips</h3>
