      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        >
          <h1 className="text-2xl font-bold tracking-tighter sm:text-2xl md:text-2xl lg:text-4xl/none bg-clip-text text-transparent
           ...
           dark:via-pink-400 dark:to-blue-400">Generate your Own Music</h1>
          <Avatar>
        ...
        <section className="mt-6">
          ...
          <Card className="p-6 bg-purple-100">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <Link to="/home">
              <Button variant="default" className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2">Compose Music</Button></Link>
            </div>
          </Card>
        </section>
        ...
        {/* Recent Projects */}
        <section className="mt-10">
          <h3 className="text-md font-semibold mb-2">Recent Projects</h3>
          <p className="text-sm text-gray-600">
            You don’t have any projects yet! Start by composing a new music track.
          </p>
        </section>
      </main>
    </div>
